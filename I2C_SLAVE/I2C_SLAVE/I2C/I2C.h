...
// Funcion de inicio de la comunicaci?n I2C 
...
// Funci?n de transmisi?n de datos maestro -> esclavo. 
    // Devuelve un 0 si el esclavo YA recibi? el dato
uint8_t I2C_Master_Write(uint8_t dato);

// Funci?n de recepci?n de datos eslavo -> maestro 
